        ...
        if (isset($_GET['id'])) {
            ...
            try {
                ...
                if ($isDeleted) {
                    ...
                    $redirectUrl = URL::to('public/admin/productlist') . '?message=Product deleted successfully';
                    header("Location: $redirectUrl");
                } else {
                    error_log("No product found with ID: $productId.");
                    $redirectUrl = URL::to('public/admin/productlist') . '?message=No product found to delete';
                    header("Location: $redirectUrl");
                }
            } catch (Exception $e) {
                error_log("Error deleting product: " . $e->getMessage());
                $redirectUrl = URL::to('public/admin/productlist') . '?message=Error deleting product';
                header("Location: $redirectUrl");
            }
            ...
            $redirectUrl = URL::to('public/admin/productlist') . '?message=Invalid product ID';
            header("Location: $redirectUrl");
            exit();
        }
    }
