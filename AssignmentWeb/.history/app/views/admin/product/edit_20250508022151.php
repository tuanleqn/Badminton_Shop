            ...
            <form id="editProductForm" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="category" name="category">
                        ...
                        <option value="1" <?php echo $product['category'] == '1' ? 'selected' : ''; ?>>Vợt cầu lông</option>
                        <option value="2" <?php echo $product['category'] == '2' ? 'selected' : ''; ?>>Giày cầu lông</option>
                        <option value="3" <?php echo $product['category'] == '3' ? 'selected' : ''; ?>>Áo cầu lông</option>
                        <option value="4" <?php echo $product['category'] == '4' ? 'selected' : ''; ?>>Quần cầu lông</option>
                        <option value="5" <?php echo $product['category'] == '5' ? 'selected' : ''; ?>>Túi vợt</option>
                        <option value="6" <?php echo $product['category'] == '6' ? 'selected' : ''; ?>>Balo thể thao</option>
                        <option value="7" <?php echo $product['category'] == '7' ? 'selected' : ''; ?>>Phụ kiện</option>
                        <option value="8" <?php echo $product['category'] == '8' ? 'selected' : ''; ?>>Quả cầu</option>
                    </select>
                </div>
                <div class="mb-3">
