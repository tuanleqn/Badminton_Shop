                ...
                if (productIndex < 1) { // Show only the first product initially
                    productsHTML += `
                        <div class="d-flex align-items-center mb-2">
                            <img src="/Shop-badminton/AssignmentWeb/${product.image || 'placeholder.jpg'}" alt="${product.name}" class="img-fluid px-1 py-1" style="width: 80px; height: 80px; object-fit: cover;">
                            <div class="ms-3">
                                <h6>${product.name}</h6>
