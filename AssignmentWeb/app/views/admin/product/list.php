                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (!empty($product['image'])): ?>
                                                <img src="/Shop-badminton/AssignmentWeb/app/<?php echo htmlspecialchars($product['image']); ?>" alt="Image" style="width: 80px; height: 80px; object-fit: cover;">
                                            <?php else: ?>
                                                <span>No Image</span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <div class="d-flex justify-content-around d-grid gap-2">
                                                ...
                                                <a href="/Shop-badminton/AssignmentWeb/app/views/admin/product/delete.php?action=delete&id=<?php echo $product['id']; ?>" 
...
<script>
    function changeEntries(limit) {
        ...
        urlParams.set('limit', limit); // Set the limit parameter
