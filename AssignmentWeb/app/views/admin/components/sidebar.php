            ...
            <ul class="menu">
                ...
                <li
                    ...
                    <ul class="submenu active">
                        ...
                        <li class="submenu-item <?php echo basename($_SERVER['PHP_SELF']) === 'list.php' || 'edit.php' || 'add.php' ? 'active' : ''; ?>">
                            <a href="list.php" class="submenu-link">Danh sách sản phẩm</a>
                        </li>
                        <li class="submenu-item <?php echo basename($_SERVER['PHP_SELF']) === 'manage_reviews.php' ? 'active' : ''; ?>">
                            <a href="manage_reviews.php" class="submenu-link">Quản lí bình luận</a>
                        </li>
