        ...
        <div class="card">
          ...
          <div class="card-content">
            <div class="card-body">
              ...
              <form class="form" data-parsley-validate method="POST" action="<?php echo URL::to('public/admin/formValidation'); ?>">
                <div class="row">
                  <?php foreach($data['formalInfo'] as $info): ?>
                    <div class="col-md-6 col-12">
                      <div class="form-group mandatory">
                        <label for="<?php echo str_replace(' ', '_', strtolower($info['name'])); ?>-column" class="form-label"><?php echo $info['name']; ?></label>
                        <input
                          type="text"
                          id="<?php echo str_replace(' ', '_', strtolower($info['name'])); ?>-column"
                          class="form-control"
                          placeholder="<?php echo $info['description']; ?>"
                          name="<?php echo str_replace(' ', '_', strtolower($info['name'])); ?>-column"
...
<script src="<?php echo URL::to('app/views/admin/assets/extensions/parsleyjs/parsley.min.js'); ?>"></script>
<script src="<?php echo URL::to('app/views/admin/assets/static/js/pages/parsley.js'); ?>"></script>
<script>
</script>
