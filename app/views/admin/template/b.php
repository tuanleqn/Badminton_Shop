<?php
// filepath: d:\Tieu_Anh\xampp\htdocs\phan2_bai3\template\b.php
            ...
            <form method="POST" action="b.php">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="image" name="image" placeholder="Nhập URL hình ảnh">
                    </div>
                </div>
                ...
                <a href="a.php" class="btn btn-secondary">Quay lại</a>
            </form>
        </div>
    </div>
</div>
