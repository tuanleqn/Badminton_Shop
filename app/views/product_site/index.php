<?php
require_once '../../controllers/fetch_products.php';
...
<head>
    ...
    <link rel="stylesheet" href="../../../asset/css/product/ps_style.css">
</head>
<body>    
    <div class="container-fluid">        
                            ...
                            foreach ($products as $product) {
                                ...
                                echo "
                                    ...
                                    echo " (" . number_format($product['average_rating'], 1) . ")</div>
                                                ...
                                                <a href='product_detail.php?id=" . $product['id'] . "' class='btn btn-custom' style='background-color: #f98850;'>Buy Now</a>
                                            </div>
                                        </div>
                                    </div>";
                            }
        ...
        <script src="../../../asset/js/ps_script.js"></script>
