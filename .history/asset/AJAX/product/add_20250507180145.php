...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $size = isset($_POST['size']) ? implode(', ', array_map('strip_tags', explode(',', $_POST['size']))) : '';
        ...
        $color = isset($_POST['color']) ? implode(', ', array_map('strip_tags', explode(',', $_POST['color']))) : '';        $size = isset($_POST['size']) ? intval($_POST['size']) : 0;
        $brandId = filter_var($_POST['brandId'], FILTER_VALIDATE_INT);
