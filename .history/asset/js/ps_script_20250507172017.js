function sortProducts(criteria) {
    ...
    products.forEach(product => {
        ...
        const brand = product.dataset.brand; // Used for filtering, not displayed
...
function filterProducts() {
    // Get selected categories, brands, and sizes
    ...
    // Filter products based on selected categories, brands, and sizes
    products.forEach(product => {
