            ...
            <div class='col-6 col-md-4 col-lg-3 mb-4'>
                <div class='product-card card h-100 d-flex flex-column' 
                    ...
                    <div class='card-body'>
                        ...
                        <a href='                                                <a href='" . URL::to('public/ProductSite/productdetail?id=' . $product['id']) . "' class='btn btn-custom' style='background-color: #f98850;'>Buy Now</a>
?id=${id}' class='btn btn-custom' >Buy Now</a>
                    </div>
                </div>
            </div>
        `;
