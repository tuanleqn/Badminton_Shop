                    ...
                    <?php
                        if (!empty($products)) {
                            foreach ($products as $product) {
                                ...
                                $name = isset($product['name']) ? htmlspecialchars($product['name']) : 'No Name'; // Default to 'No Name' if name is not set
                                $price = isset($product['price']) ? htmlspecialchars($product['price']) : '0.00'; // Default to '0.00' if price is not set
