...
<body>    
    <div class="container-fluid">        
        ...
        <div id="brandContainer">
            <?php
            if (!empty($displayedBrands)) {
                foreach ($displayedBrands as $brand) {
                    echo "
                    <div class='form-check'>
                        <input class='form-check-input' type='checkbox' value='" . strtolower($brand) . "' id='brand-" . strtolower($brand) . "'>
                        <label class='form-check-label' for='brand-" . strtolower($brand) . "'>
                            $brand
                        </label>
                    </div>";
                }
        ...
        <div id="sizeContainer">
            <?php
            if (!empty($displayedSizes)) {
                foreach ($displayedSizes as $size) {
                    echo "
                    <div class='form-check'>
