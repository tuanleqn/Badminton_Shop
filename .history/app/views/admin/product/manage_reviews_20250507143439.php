                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row['status'] === 'rejected'): ?>
                                                <a href="#" class="btn btn-success btn-sm update-status-btn" data-id="<?php echo $row['id']; ?>" data-status="approved">
                                                    <span class="d-none d-md-inline">Approve</span>
                                                    <i class="bi bi-check d-md-none"></i>
                                                </a>
                                            <?php elseif ($row['status'] === 'approved'): ?>
                                                <a href="#" class="btn btn-danger btn-sm update-status-btn" data-id="<?php echo $row['id']; ?>" data-status="rejected">
