...
<body>
    ...
    <?php require_once dirname(__DIR__) . '/components/sidebar.php'; ?>
        ...
        <a href="#" class="text-success update-status-btn" data-id="<?php echo $order['orderId']; ?>" data-status="pending" title="Reopen">
            <span class="d-none d-md-inline">Reopen</span>
            <i class="bi bi-arrow-clockwise fs-5 d-md-none"></i>
        </a>
    <?php elseif ($order['status'] === 'pending'): ?>
        <a href="#" class="text-success me-2 update-status-btn" data-id="<?php echo $order['orderId']; ?>" data-status="shipped" title="Ship">
            <span class="d-none d-md-inline">Ship</span>
            <i class="bi bi-truck fs-5 d-md-none"></i>
        </a>
        <a href="#" class="text-danger update-status-btn" data-id="<?php echo $order['orderId']; ?>" data-status="cancelled" title="Cancel">
            <span class="d-none d-md-inline">Cancel</span>
            <i class="bi bi-x fs-5 d-md-none"></i>
        </a>
    <?php elseif ($order['status'] === 'shipped'): ?>
        <a href="#" class="text-success update-status-btn" data-id="<?php echo $order['orderId']; ?>" data-status="delivered" title="Deliver">
            <span class="d-none d-md-inline">Deliver</span>
            <i class="bi bi-box-seam fs-5 d-md-none"></i>
        </a>
    <?php endif; ?>
                                        </td>
                                    </tr>
