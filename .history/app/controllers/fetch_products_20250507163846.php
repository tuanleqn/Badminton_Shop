...
$products = $productModel->getProductsByCategory($categoryId, $limit, $offset, $orderBy);
// Case 3 : fetch products in a category with brandId
$brandId = isset($_GET['brand_id']) ? (int)$_GET['brand_id'] : 0;
$products = $productModel->getProductsByCategoryAndBrand($categoryId, $brandId, $limit, $offset, $orderBy);
