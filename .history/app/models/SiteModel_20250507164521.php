...
class SiteModel {
    ...
    public function getAllProducts($limit, $offset, $orderBy = 'p.id ASC', $category = null, $brandId = null) {
        // Base query
        $query = "
            SELECT 
                p.id, 
        ...
        // Add conditions based on the cases
        $conditions = [];
        $params = [];
        $types = '';
        ...
        // Case 3: Filter by brandId and category
        if ($brandId !== null) {
    ...
    public function getProductsByCategory($category, $limit = 10, $offset = 0, $orderBy = 'p.id ASC') {
